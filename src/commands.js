...
export const commands = [
  ...
  new SlashCommandBuilder()
    .setName("award-role")
    .setDescription("Award 1–5 approved BCSO qualification or unit roles in one approval.")
    .addUserOption(option => option.setName("member").setDescription("Member receiving the role.").setRequired(true))
    .addStringOption(option => option.setName("role").setDescription("First role; add role-2 through role-5 for a batch.").setAutocomplete(true).setRequired(true))
    .addStringOption(option => option.setName("date").setDescription("Choose Today to pre-fill the effective date.").setRequired(true).addChoices(...DATE_CHOICES))
    .addStringOption(option => option.setName("role-2").setDescription("Optional additional role (2 of 5).").setAutocomplete(true))
    .addStringOption(option => option.setName("role-3").setDescription("Optional additional role (3 of 5).").setAutocomplete(true))
    .addStringOption(option => option.setName("role-4").setDescription("Optional additional role (4 of 5).").setAutocomplete(true))
    .addStringOption(option => option.setName("role-5").setDescription("Optional additional role (5 of 5).").setAutocomplete(true)),
  new SlashCommandBuilder()
    .setName("remove-role")
    .setDescription("Remove 1–5 approved BCSO qualification or unit roles in one approval.")

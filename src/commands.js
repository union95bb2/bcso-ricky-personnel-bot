...
export const commands = [
  ...
  new SlashCommandBuilder()
    ...
    .addRoleOption(option => option.setName("role").setDescription("First role; add role-2 through role-5 for a batch.").setRequired(true))
    .addStringOption(option => option.setName("date").setDescription("Choose Today to pre-fill the effective date.").setRequired(true).addChoices(...DATE_CHOICES))
    .addRoleOption(option => option.setName("role-2").setDescription("Optional additional role (2 of 5)."))
    .addRoleOption(option => option.setName("role-3").setDescription("Optional additional role (3 of 5)."))
    .addRoleOption(option => option.setName("role-4").setDescription("Optional additional role (4 of 5)."))
    .addRoleOption(option => option.setName("role-5").setDescription("Optional additional role (5 of 5).")),
  new SlashCommandBuilder()
    .setName("remove-role")

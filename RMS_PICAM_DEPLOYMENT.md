...
- **Qualification and promotion evidence:** records can carry an expiration date; the home page lists qualifications expiring within 30 days. A jacket-level eligibility check counts finalized evidence and reports blockers as an advisory result only. It never changes a rank or decides promotion.
